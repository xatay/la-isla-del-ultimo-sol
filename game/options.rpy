...
init python:
    renpy.music.register_channel("menu_music", "music")

define config.name = _("La Isla del Ultimo Sol")
...
define build.name = "LaIsladelUltimoSol"
...
#define config.main_menu_music = "audio/Musica-menu.ogg"
...
define config.save_directory = "LaIsladelUltimoSol-1757634202"
